...
* Supportverktyg {#support-tools}
   ...
   * Patchar tillgängliga i QPT-verktyget {#patches}
      ...
      * v1.1.4 {#v1-1-4}
         ...
         * [MDVA-26005: Det går inte att välja kategori i trädet för villkor för kundvagnsprisregeln](/help/support-tools/patches-available-in-qpt-tool/v1-1-4/mdva-26005-unable-to-select-category-in-tree-for-cart-price-rule-conditions.md)
         * [MDVA-29400: Duplicerade beställningar gjorda med PayPal Express Checkout](/help/support-tools/patches-available-in-qpt-tool/v1-1-4/mdva-29400-duplicated-orders-placed-with-paypal-express-checkout.md)
         * [MDVA-37725: E-postmeddelanden som skickas via webbplatser som inte är standard innehåller webbadresser till standardwebbplatsens logotyp](/help/support-tools/patches-available-in-qpt-tool/v1-1-4/mdva-37725-asynchronous-order-emails-sent-via-non-default-websites-containing-default-websites-logo-urls.md)
         * [MDVA-39482: Produkten tar slut i lager om den importeras med kvantiteten &quot;0&quot; med restorder aktiverade](/help/support-tools/patches-available-in-qpt-tool/v1-1-4/mdva-39482-product-goes-out-of-stock-when-imported-with-0-quantity.md)
         * [MDVA-40101: Varor förblir minivagnar efter beställning PayPal Express Checkout](/help/support-tools/patches-available-in-qpt-tool/v1-1-4/mdva-40101-items-remain-in-mini-cart-after-order-placement-using-paypal-express-checkout.md)
      ...
      * v1.1.6 {#v1-1-6}
         ...
         * [MDVA-32776: Lagerstatus uppdateras inte vid orderläggning](/help/support-tools/patches-available-in-qpt-tool/v1-1-6/mdva-32776-stock-status-not-updated-when-order-placed.md)
      ...
      * v1.1.9 {#v1-1-9}
         ...
         * [MDVA-38346: Datumfilter fungerar inte när tidszonen för Adobe Commerce skiljer sig från den lokala](/help/support-tools/patches-available-in-qpt-tool/v1-1-9/mdva-38346-date-filters-not-working-properly-when-adobe-commerce-timezone-is-different-from-local.md)
         ...
         * [MDVA-42806: E-post om registrering av nytt företag skickas varje gång ett befintligt företag uppdateras](/help/support-tools/patches-available-in-qpt-tool/v1-1-9/mdva-42806-new-company-registration-email-is-sent-each-time-an-existing-company-is-updated-via-reset-api.md)
      * v1-1-10 {#v1-1-10}
      ...
      * v1.1.13 {#v1-1-13}
         ...
         * [MDVA-43824: Åtgärden för annullering av beställning misslyckades med felet &quot;Du har inte avbrutit artikeln&quot;](/help/support-tools/patches-available-in-qpt-tool/v1-1-13/mdva-43824-order-cancellation-action-failed-with-error.md)
      ...
      * v1.1.14 {#v1-1-14}
         ...
         * [MDVA-43178: Det går inte att hämta kundtoken för anpassad butik i GraphQL](/help/support-tools/patches-available-in-qpt-tool/v1-1-14/mdva-43178-customer-token-for-custom-store-cannot-be-retrieved.md)
         * [MDVA-43605: Orderdata returnerar negativa värden för radsummor vid användning av Rest API](/help/support-tools/patches-available-in-qpt-tool/v1-1-14/mdva-43605-order-data-returns-negative-values-for-row-totals-when-using-rest-api.md)
         * [MDVA-43859: Felet &quot;Ingen sådan enhet med customerId =&quot; loggas när borttagna kunder loggar in](/help/support-tools/patches-available-in-qpt-tool/v1-1-14/mdva-43859-error-no-such-entity-with-customerid.md)
      ...
      * v1.1.15 {#v1-1-15}
         ...
         * [MDVA-38559: /V1/customers/search API returnerar fel](/help/support-tools/patches-available-in-qpt-tool/v1-1-15/mdva-38559-v1-customers-search-api-error.md)
         ...
         * [MDVA-40961: Det går inte att lägga till ytterligare artiklar i kundvagnen när minsta antal artiklar redan finns i varukorgen](/help/support-tools/patches-available-in-qpt-tool/v1-1-15/mdva-40961-additional-item-cant-be-added-to-cart-when-minimum-qty-of-the-item-already-in-cart.md)
         ...
         * [MDVA-44533: Rabatten tillämpas felaktigt på underordnade produkter](/help/support-tools/patches-available-in-qpt-tool/v1-1-15/mdva-44533-discount-incorrectly-applied-to-bundle-child-product.md)
         * [MDVA-44660: Det går inte att använda grav accent för kundens namn](/help/support-tools/patches-available-in-qpt-tool/v1-1-15/mdva-44660-grave-accent-character-cannot-be-used-for-customer-name.md)
         * [MDVA-44887: Felet &quot;Uncaught SyntaxError: Unexpected token const&quot; i adminpanelen](/help/support-tools/patches-available-in-qpt-tool/v1-1-15/mdva-44887-uncaught-syntaxerror-unexpected-token-const-error-in-admin-panel.md)
      * v1.1.16 {#v1-1-16}
      ...
      * v1.1.18 {#v1-1-18}
         * [Översikt: Verktyg för kvalitetskorrigeringar (QPT) v1.1.18](/help/support-tools/patches-available-in-qpt-tool/v1-1-18/overview.md)
      ...
      * v1.1.21 {#v1-1-21}
         * [Översikt: Verktyget Quality Patches (QPT) v1.1.21](/help/support-tools/patches-available-in-qpt-tool/v1-1-21/overview.md)
         * [ACSD-45071: Standardkälla tillagd i produkten under import](/help/support-tools/patches-available-in-qpt-tool/v1-1-21/acsd-45071-default-source-added-to-product-during-import.md)
         ...
         * [ACSD-46988: GraphQL-valuta-API-begäran returnerar null-värden](/help/support-tools/patches-available-in-qpt-tool/v1-1-21/acsd-46988-graphql-currency-api-request-returns-null-values.md)
         * [ACSD-47076: Vimeo-videor kan inte spelas upp i skyltfönstret](/help/support-tools/patches-available-in-qpt-tool/v1-1-21/acsd-47076-venmo-videos-cannot-be-played-on-the-storefront.md)
      * v1.1.22 {#v1-1-22}
      ...
      * v1.1.25 {#v1-1-25}
         ...
         * [ACSD-48627: Ett fel orsakas av konfigurerbar produkt som är slut i lager](/help/support-tools/patches-available-in-qpt-tool/v1-1-25/acsd-48627-out-of-stock-configurable-product-causes-an-error.md)
         * [ACSD-48234: Katalogsökresultatet visar felaktigt antal kategoriartiklar när [!UICONTROL Display Out of Stock Products] det är aktiverat](/help/support-tools/patches-available-in-qpt-tool/v1-1-25/acsd-48234-catalog-search-result-shows-incorrect-category-item-count-when-show-out-of-stock-option-enabled.md)
         * [ACSD-47520: Kunder förlorar belöningspoäng när en kreditnota skapas](/help/support-tools/patches-available-in-qpt-tool/v1-1-25/acsd-47520-customers-lose-reward-points-when-credit-memo-created.md)
         * [ACSD-48044: Användning av flera presentkort förhindrar att beställningar görs](/help/support-tools/patches-available-in-qpt-tool/v1-1-25/acsd-48044-applying-multiple-gift-cards-prevents-orders.md)
         * [ACSD-48300: Retur kan inte skapas om den konfigurerbara produkten tas bort](/help/support-tools/patches-available-in-qpt-tool/v1-1-25/acsd-48300-return-cannot-be-created-if-configurable-product-removed.md)
      ...
      * v1.1.26 {#v1-1-26}
         ...
         * [ACSD-47937: Meddelanden om prissänkningar skickas inte på grund av cachelagring på applikationsnivå](/help/support-tools/patches-available-in-qpt-tool/v1-1-26/acsd-47937-price-drop-notifications-are-not-sent.md)
         * [ACSD-48661: Valideringsproblem med validering av kommaavgränsare för företagskreditgräns](/help/support-tools/patches-available-in-qpt-tool/v1-1-26/acsd-48661-company-credit-limit-comma-separator-validation.md)
      ...
      * V1.1.27 {#v1-1-27}
         * [ACSD-48404: Kom ihåg kategorisidnumrering = ja orsakar ett fel](/help/support-tools/patches-available-in-qpt-tool/v1-1-27/acsd-48404-fixes-the-issue-where-remember-category-pagination-yes-causes-an-error.md)
         * [Överblick](/help/support-tools/patches-available-in-qpt-tool/v1-1-27/overview.md)
         * [ACSD-48634: [!DNL JS] fel vid [!DNL Google Analytics Content Experiments] aktivering](/help/support-tools/patches-available-in-qpt-tool/v1-1-27/acsd-48634-js-errors-when-google-analytics-content-experiments-enabled.md)
         ...
         * [ACSD-48216: AUTO_INCREMENT av inventory_source_item tabellen ökar vid UPDATE-åtgärd](/help/support-tools/patches-available-in-qpt-tool/v1-1-27/acsd-48216-auto-increment-of-inventory-source-item-table-increases-on-the-update-operation.md)
         * [ACSD-49497: Beställningen bearbetas fortfarande efter leverans och delvis återbetalning](/help/support-tools/patches-available-in-qpt-tool/v1-1-27/acsd-49497-order-is-still-processing-after-shipment-and-partial-refund.md)
         * [ACSD-48694: Fel med ogiltig tillståndsändring begärd hindrar kunden från att lägga order](/help/support-tools/patches-available-in-qpt-tool/v1-1-27/acsd-48694-invalid-state-change-requested-error-prevents-customer-from-placing-order.md)
      * v1.1.28 {#v1-1-28}
         * [Översikt: [!DNL Quality Patches Tool] (QPT) v1.1.28](/help/support-tools/patches-available-in-qpt-tool/v1-1-28/overview.md)
         * [ACSD-49179: orderrapporten visar felaktiga belopp för olika butiker](/help/support-tools/patches-available-in-qpt-tool/v1-1-28/acsd-49179-orders-report-shows-incorrect-amounts-for-different-stores.md)
         * [ACSD-49065: Offertartiklar är inte synliga i admin om de tilldelas anpassat lager](/help/support-tools/patches-available-in-qpt-tool/v1-1-28/acsd-49065-quote-items-are-not-visible-in-admin-if-assigned-to-custom-stock.md)
      ...
      * v1.1.31 {#v1-1-31}
         ...
         * [ACSD-50858: Förbättrad prestanda för inläsning av bannerinnehåll](/help/support-tools/patches-available-in-qpt-tool/v1-1-31/acsd-50858-improved-performance-for-loading-banners-content.md)
         * [ACSD-49392: Orderstatusen ändras till stängd efter partiell återbetalning](/help/support-tools/patches-available-in-qpt-tool/v1-1-31/acsd-49392-order-status-changes-to-closed-after-partial-refund.md)
      ...
      * v1.1.33 {#v1-1-33}
         ...
         * [ACSD-50895: Google Analytics 3 GTM-taggar aktiveras inte om Google Analytics 4 GTM inte är konfigurerat](/help/support-tools/patches-available-in-qpt-tool/v1-1-33/acsd-50895-google-analytics-3-gtm-tags-are-not-fired-if-google-analytics-4-gtm-is-not-configured.md)
         * [ACSD-51471: Administratörsanvändare kan inte spara schemalagd uppdatering för paketerad produkt](/help/support-tools/patches-available-in-qpt-tool/v1-1-33/acsd-51471-admin-user-cannot-save-scheduled-update-for-bundled-product.md)
         * [ACSD-51120: Cacheminnet för GraphQL GET-förfrågningar rensas inte för CMS-sidor som innehåller CMS-block](/help/support-tools/patches-available-in-qpt-tool/v1-1-33/acsd-51120-graphql-get-requests-cache-not-cleared-for-cms-pages.md)
         * [ACSD-51700: Det gick inte att växla mellan butiksvyer på den nedladdningsbara produktredigeringssidan](/help/support-tools/patches-available-in-qpt-tool/v1-1-33/acsd-51700-downloadable-product-error-when-switching-storeviews.md)
         * [ACSD-51735: Orderartikelstatus är felaktigt inställd på [!UICONTROL Ordered] när produktlagret är 0](/help/support-tools/patches-available-in-qpt-tool/v1-1-33/acsd-51735-order-item-status-incorrectly-set.md)
      ...
      * v1.1.34{#v1-1-34}
         ...
         * [ACSD-51853: Kopierade textstilar används inte med Page Builder](/help/support-tools/patches-available-in-qpt-tool/v1-1-34/acsd-51853-copied-text-styles-are-not-applied-when-page-builder-is-used.md)
         * [ACSD-51630: Många systemmeddelanden långsam hämtning av administratörssidor](/help/support-tools/patches-available-in-qpt-tool/v1-1-34/acsd-51630-large-amount-of-system-messages-slows-the-downloading-of-admin-pages.md)
         * [ACSD-52689: Bilder kan inte laddas upp till Amazon S3-lagring via REST API](/help/support-tools/patches-available-in-qpt-tool/v1-1-34/acsd-52689-images-cannot-be-uploaded-to-amazon-s3-storage-using-rest-api.md)
      ...
      * v1.1.36{#v1-1-36}
         ...
         * [ACSD-52906: Löser X-Magento-Vary-problem med cookie för inloggad kundcache](/help/support-tools/patches-available-in-qpt-tool/v1-1-36/acsd-52906-resolving-x-magento-vary-cookie-issue-logged-in-customer-caching.md)
      * v1.1.37 {#v1-1-37}
      ...
      * v1.1.42 {#v1-1-42}
         ...
         * [ACSD-54418: Fast rabattbelopp har felaktigt lagts till för en underordnad produkt i ett dynamiskt prissatt paket](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-54418-fixed-discount-amount-incorrectly-added-to-child-product-of-dynamically-priced-bundle.md)
      ...
      * v1.1.44 {#v1-1-44}
         ...
         * [ACSD-55231: Felet att SKU inte hittades vid användning av snabborderfunktionen](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-55231-sku-not-found-in-catalog.md)
         * [ACSD-55352: Skapa [!UICONTROL Credit Memo] med belöningspoäng](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-55352-creating-credit-memos-with-reward-points.md)
         * [ACSD-55427: Administratörsanvändare kan inte ta bort tilldelningen av en produkt från den delade katalogen från produktsidan](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-55427-admin-user-cannot-unassign-product-from-shared-catalog-from-product-page.md)
         * [ACSD-56280: Köp i presentregistret har inte slutförts](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-56280-gift-registry-purchases-are-not-completed.md)
         * [ACSD-56193: [!DNL Fastly/Varnish] cacheminnet rensas inte för uppdatering av innehållsmellanlagring](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-56193-fastly-cache-not-cleared-for-content-staging-update.md)
         * [ACSD-56158: Fel skattevärde i GraphQL-svar när flera skatteregler tillämpas på kundvagnen](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-56158-wrong-tax-value-in-graphql-when-multiple-tax-rules-applied-to-cart.md)
         * [ACSD-56023: Widgetinnehållet uppdateras inte på CMS-sidan](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-56023-widget-content-not-updating-on-the-cms-page.md)
         * [ACSD-56246: Schemaläggning av produktuppdateringar rensar attributvärden för flerval](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-56246-scheduling-product-updates-clears-multiselect-attributes-values.md)
         * [ACSD-56790: Alternativet Flytta slut i lager till botten fungerar inte vid sortering av produkter i Visual Merchandiser](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-56790-move-out-of-stock-to-bottom-option-does-not-work-while-sorting-products-in-the-visual-merchandiser.md)
      * v1.1.45 {#v1-1-45}
         * [Översikt: [!DNL Quality Patches Tool] (QPT) v1.1.45](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/overview.md)
         * [ACSD-56447: Att lägga till samma produkt i kundvagnen via parallella web REST API-förfrågningar resulterar i två separata artiklar i kundvagnen](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/acsd-56447-adding-same-product-to-cart-via-parallel-web-api-rest-requests-results-in-two-separate-items-in-the-cart.md)
         * [ACSD-54965: [!UICONTROL Visual Merchandising] rutnätet visar inte rätt lager](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/acsd-54965-visual-merchandising-grid-not-display-correct-stock.md)
         ...
         * [ASCD-56415: Prestandan för fördröjs på grund av [!UICONTROL Partial Price Indexing] DELETE-fråga](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/acsd-56415-performance-of-partial-price-indexing-is-slowed-down-due-to-a-delete-query.md)
      * v1.1.46 {#v1-1-46}
         * [Översikt: [!DNL Quality Patches Tool] (QPT) v1.1.46](/help/support-tools/patches-available-in-qpt-tool/v1-1-46/overview.md)
         * [ACSD-46767: [!UICONTROL Category] sidcacher ogiltigförklaras när lagerkvantiteten ändras](/help/support-tools/patches-available-in-qpt-tool/v1-1-46/acsd-46767-category-page-caches-invalidate-when-the-stock-quantity-changes.md)
      ...
      * v1.1.49 {#v1-1-49}
         ...
         * [ACSD-58446: Om du tar bort ett team med underordnade användare eller team via GraphQL uppstår ett oinformativt fel](/help/support-tools/patches-available-in-qpt-tool/v1-1-49/ascd-58446-deleting-a-team-with-child-users-or-teams-via-graphql-gives-an-uninformative-error-message.md)
      ...
      * v1.1.50 {#v1-1-50}
         ...
         * [ACSD-58141: PHPSESSID återskapar POST-begäranden för inloggade kunder om L2 Redis-cache är aktiverat](/help/support-tools/patches-available-in-qpt-tool/v1-1-50/acsd-58141-phpsessid-regenerates-on-post-requests-for-logged-in-customers-with-l2-redis-cache-enabled.md)
         ...
         * [ACSD-58442: Åtgärdar problemet där enheter med en bredd på 768px behandlas som mobila, vilket gör att menyer och rubriker läses in i mobilvyn och inte på skrivbordet](/help/support-tools/patches-available-in-qpt-tool/v1-1-50/acsd-58442-fixes-issue-devices-768px-mobile-view-instead-desktop.md)
         * [ACSD-48210: Attribut för butiksvyspecifikt omfång åsidosätter globala värden](/help/support-tools/patches-available-in-qpt-tool/v1-1-50/acsd-48210-store-view-specific-scope-attribute-overrides-global-values.md)
      ...
      * [Leta efter Commerce-problem med verktyget för kvalitetskorrigeringar](/help/support-tools/patches-available-in-qpt-tool/check-patch-for-magento-issue-with-magento-quality-patches.md)
* Meddelanden {#announcements}
   ...
   * Help Center News {#news}
      * [Avveckling av Adobe Commerce Help Center](/help/announcements/help-center-news/decommissioning-of-adobe-commerce-help-center.md)
* Felsökning av {#troubleshooting}
   ...
   * Betalningar {#payments}
      ...
      * [Adobe Commerce 2.4.1 känt problem: fel dyker upp i kassan med PayPal Braintree](/help/troubleshooting/payments/magento-2-4-1-known-issue-error-popping-up-on-checkout-with-paypal-braintree.md)
      ...
      * [Cybersource-betalning från Admin och front på olika domäner behandlas inte](/help/troubleshooting/payments/cybersource-payment-from-admin-and-front-on-different-domains-not-processed.md)
      * [Känt problem med Adobe Commerce 2.4.0: Amazon Pay, inga betalningsmetoder](/help/troubleshooting/payments/magento-2-4-0-known-issue-amazon-pay-no-payment-methods.md)
      * [Adobe Commerce 2.3.7-p1 känt problem: inaktuell ordersumma för PayPal](/help/troubleshooting/payments/paypal-price-known-issue-commerce-237p1.md)
      * [Korrigeringsfil för problem med Amazon Pay-utcheckning i Adobe Commerce 2.3.5-p1](/help/troubleshooting/payments/patch-for-amazon-pay-checkout-issue-in-magento-2-3-5-p1.md)
   ...
   * Installation och uppgradering av {#installation-and-upgrade}
      ...
      * [Felsöka fel med kompatibilitetsverktyget för uppgradering](/help/troubleshooting/installation-and-upgrade/uct-segmentation-fault-error.md)
      * [Fel om slut på minne under installation eller uppgradering](/help/troubleshooting/installation-and-upgrade/out-of-memory-error-during-install-or-upgrade.md)
   * Webbplatsen är nere eller svarar inte {#site-down-or-unresponsive}
      ...
      * [Felsökningsverktyg för Adobe Commerce-webbplats](/help/troubleshooting/site-down-or-unresponsive/magento-site-down-troubleshooter.md)
      * [Att applicera en patch tar din webbplats ner](/help/troubleshooting/site-down-or-unresponsive/applying-a-patch-takes-your-site-down.md)
   ...
   * Övrigt {#miscellaneous}
      ...
      * [Index ogiltigförklaras och &quot;indexer_reindex_all_invalid&quot; körs hela tiden](/help/troubleshooting/miscellaneous/constant-reindexing-with-cron-job-indexer-reindex-all-invalid.md)
      * [Konfigurationsfil saknas eller har ändrats](/help/troubleshooting/miscellaneous/missing-or-altered-config-file.md)
      ...
      * [Felsöka modulen Product Recommendations i Adobe Commerce](/help/troubleshooting/miscellaneous/troubleshoot-product-recommendations-module-in-magento-commerce.md)
      * [Ta bort filer på ett säkert sätt när diskutrymmet tar slut i Adobe Commerce i molninfrastrukturen](/help/troubleshooting/miscellaneous/safely-delete-files-when-out-of-disk-space-adobe-commerce-on-our-cloud-architecture.md)
      * [robots.txt inte uppdaterad eller visar standardinställningar](/help/troubleshooting/miscellaneous/robots-txt-not-updated-or-displaying-default-settings.md)
      ...
      * [Vertex Address Cleansing: olika adresser är inte tillåtna](/help/troubleshooting/miscellaneous/vertex-address-cleansing-different-addresses-not-allowed.md)
      ...
      * [504 Gateway Timeout-fel när du sparar en kategori med 1K+ produkter](/help/troubleshooting/miscellaneous/504-gateway-time-out-error-when-saving-a-category-with-1k-products.md)
      * [Felmeddelande när du lägger till webbplatser i Security Scan](/help/troubleshooting/miscellaneous/error-message-adding-site-into-security-scan.md)
      ...
      * [Det går inte att ta bort källan eller ändra dess kod](/help/troubleshooting/miscellaneous/cannot-delete-the-source-or-change-its-code.md)
      ...
      * [Det går inte att spara entiteten Adobe Commerce backend](/help/troubleshooting/miscellaneous/unable-to-save-entity-backend.md)
      ...
      * [Fel vid rensning av Fastly-cache i molnet (rensningsbegäran bearbetades inte korrekt)](/help/troubleshooting/miscellaneous/error-purging-fastly-cache-on-cloud-the-purge-request-was-not-processed-successfully.md)
      ...
      * [PWA Studio: Valideringsfel när utvecklarläge körs](/help/troubleshooting/miscellaneous/pwa-studio-validation-errors-when-running-developer-mode.md)
      ...
      * [Installera de senaste korrigeringarna för att åtgärda problem med Adobe Commerce Redis](/help/troubleshooting/miscellaneous/install-latest-patches-to-fix-magento-redis-issues.md)
      * [Lösa ett ogiltigt förskjutningsfel](/help/troubleshooting/miscellaneous/resolve-an-illegal-offset-error.md)
      * [GraphQL-fråga för att dölja kategorier fungerar inte med B2B-delad katalog](/help/troubleshooting/miscellaneous/graphql-categories-cannot-hide-categories-shared-catalog.md)
      ...
      * [Fastly Error: Plugin VCL-versionen är föråldrad! Ladda upp igen](/help/troubleshooting/miscellaneous/fastly-error-plugin-vcl-version-is-outdated-please-re-upload.md)
      * [Adobe Commerce 2.4.0: det går inte att uppdatera kundens aktiviteter](/help/troubleshooting/miscellaneous/magento-2-4-0-refresh-on-customer-activities-does-not-work.md)
      ...
      * [Det går inte att ta bort filen. Varning! unlink: Inget sådant fil- eller katalogfel* från [!DNL Admin]](/help/troubleshooting/miscellaneous/file-cannot-be-deleated-no-file-or-directory.md)
      * [[!DNL Admin] Inloggningen fungerar inte – den tillåtna sessionens maximala storlek har överskridits](/help/troubleshooting/miscellaneous/admin-login-not-working-allowed-session-max-size-exceed.md)
      ...
      * [Dålig prestanda i integrationsmiljöer](/help/troubleshooting/miscellaneous/poor-performance-in-integration-environments.md)
   * Utplacering {#deployment}
   ...
   * Kända fel {#known-issues-patches-attached}
      ...
      * [Avancerad sökning visar inte de mest relevanta resultaten](/help/troubleshooting/known-issues-patches-attached/advanced-search-not-showing-the-most-relevant-results.md)
      * [Fel vid filtrering av beställningar i Admin](/help/troubleshooting/known-issues-patches-attached/error-when-filtering-orders-in-admin.md)
   ...
   * Elasticsearch {#elasticsearch}
      * [Återgå till [!DNL Elasticsearch7] när sökmotorn är inställd på [!DNL Opensearch]](/help/troubleshooting/elasticsearch/falling-back-to-elasticsearch7-when-search-engine-set-to-opensearch.md)
      * [Problem med Elasticsearch efter uppgradering av Adobe Commerce molninfrastruktur 2.3.1+](/help/troubleshooting/elasticsearch/elasticsearch-issues-after-magento-commerce-cloud-2-3-1-upgrade.md)
...
* Guide till hjälpcentret {#help-center-guide}
