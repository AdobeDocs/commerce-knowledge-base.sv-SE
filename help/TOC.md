...
* Supportverktyg {#support-tools}
   ...
   * Patchar tillgängliga i QPT-verktyget {#patches}
      ...
      * v1.0.5 {#v1-0-5}
         * [Översikt: QPT (Quality Patches Tool) v1.0.5](/help/support-tools/patches-available-in-qpt-tool/v1-0-5/overview.md)
         * [MDVA-28191: Ingen betalningsmetod för en webbplats i Admin - Skapa ny order](/help/support-tools/patches-available-in-qpt-tool/v1-0-5/mdva-28191-magento-patch-no-payment-method-for-one-website-in-admin-create-new-order.md)
         * [MDVA-28409-korrigering: Adobe Commerce webbserver kraschar - slut på minne](/help/support-tools/patches-available-in-qpt-tool/v1-0-5/mdva-28409-magento-patch-magento-web-server-crashing-out-of-memory.md)
         * [MDVA-28661: Problem med hantering av företagsanvändare vid ändring av administratörens e-post](/help/support-tools/patches-available-in-qpt-tool/v1-0-5/mdva-28661-magento-patch-issue-with-company-users-management-when-changing-admin-email.md)
         * [MDVA-28763: Problem med att hantera produktbilder via REST API](/help/support-tools/patches-available-in-qpt-tool/v1-0-5/mdva-28763-magento-patch-issues-with-managing-product-images-via-rest-api.md)
         * [MDVA-29042: De globala kategoribehörigheterna ändras inte](/help/support-tools/patches-available-in-qpt-tool/v1-0-5/mdva-29042-magento-patch-global-category-permissions-unchanged.md)
         * [MDVA-29959-korrigering: Administratör med behörighet &quot;Kunder&quot; kan inte hantera företagskonto](/help/support-tools/patches-available-in-qpt-tool/v1-0-5/mdva-29959-magento-patch-admin-with-customers-permissions-cannot-manage-company-account.md)
         * [MDVA-30107: Butiksväxlaren fungerar inte som förväntat](/help/support-tools/patches-available-in-qpt-tool/v1-0-5/mdva-30107-magento-patch-store-switcher-does-not-work-as-expected.md)
         * [MDVA-30265: Länk för spårning i e-post returnerar 404 sidor hittades inte](/help/support-tools/patches-available-in-qpt-tool/v1-0-5/mdva-30265-magento-patch-tracking-link-in-email-returns-404-page-not-found.md)
         * [MDVA-30284 Patch: Elasticsearch 7 - Limit of total fields [XXXXX] in index has been been been been been been been been](/help/support-tools/patches-available-in-qpt-tool/v1-0-5/mdva-30284-magento-patch-elasticsearch-7-limit-of-total-fields-xxxxx-in-index-has-been-exceeded.md)
         * [MDVA-30428: Önsklista fungerar inte med Inventory management](/help/support-tools/patches-available-in-qpt-tool/v1-0-5/mdva-30428-magento-patch-wishlist-not-working-with-the-msi.md)
         * [MDVA-30593-korrigering: Utgångna citattecken rensas inte](/help/support-tools/patches-available-in-qpt-tool/v1-0-5/mdva-30593-magento-patch-expired-quotes-are-not-cleaned-up.md)
      * v1.0.6 {#v1-0-6}
         * [Översikt: QPT (Quality Patches Tool) v1.0.6](/help/support-tools/patches-available-in-qpt-tool/v1-0-6/overview.md)
         * [MDVA-28202-korrigering: Produkterna som inte finns i lager filtreras inte korrekt](/help/support-tools/patches-available-in-qpt-tool/v1-0-6/mdva-28202-magento-patch-out-of-stock-products-don-t-filter-properly.md)
         * [MDVA-28300: Prisberäkningsproblem med katalogprisregel i GraphQL](/help/support-tools/patches-available-in-qpt-tool/v1-0-6/mdva-28300-magento-patch-price-calculation-issue-with-catalog-price-rule-in-graphql.md)
         * [MDVA-28993: partiell sökning i Elasticsearch, &quot;minimum should match&quot; och korrigering för &quot;searches with binphen&quot; issue](/help/support-tools/patches-available-in-qpt-tool/v1-0-6/mdva-28993-magento-patch-elasticsearch-partial-search-minimum-should-match-and-fix-for-searches-with-hyphen-issue.md)
         * [MDVA-29446: Ej relevant leveransmetod för utcheckning](/help/support-tools/patches-available-in-qpt-tool/v1-0-6/mdva-29446-magento-patch-non-relevant-shipping-method-available-for-checkout.md)
         * [MDVA-29787: Relaterade produkter visas inte](/help/support-tools/patches-available-in-qpt-tool/v1-0-6/mdva-29787-magento-patch-related-products-are-not-displayed.md)
         * [MDVA-30102: Redis-cachen börjar bli full](/help/support-tools/patches-available-in-qpt-tool/v1-0-6/mdva-30102-magento-patch-redis-cache-getting-full.md)
         * [MDVA-30357: Webbplatskartan som genereras av cron har fel bild-URL](/help/support-tools/patches-available-in-qpt-tool/v1-0-6/mdva-30357-magento-patch-sitemap-generated-by-cron-has-wrong-image-url.md)
         * [MDVA-30565: Problem med lokal lagring och utcheckning av sessionscache](/help/support-tools/patches-available-in-qpt-tool/v1-0-6/mdva-30565-magento-patch-session-cache-local-storage-and-checkout-issue.md)
         * [MDVA-30599: Customer_is_gäst är felaktigt inställd](/help/support-tools/patches-available-in-qpt-tool/v1-0-6/mdva-30599-magento-patch-customer-is-guest-is-set-incorrectly.md)
         * [MDVA-30977: Produkter från kategorier saknas, indexering relaterade](/help/support-tools/patches-available-in-qpt-tool/v1-0-6/mdva-30977-magento-patch-missing-products-from-categories-indexing-related.md)
         * [MDVA-31006: PayPal-dubblettorder 10415-fel](/help/support-tools/patches-available-in-qpt-tool/v1-0-6/mdva-31006-magento-patch-paypal-duplicate-orders-10415-error.md)
      * v1.0.7 {#v1-0-7}
         ...
         * [MDVA-30594: Flera adresschasseringsfel](/help/support-tools/patches-available-in-qpt-tool/v1-0-7/mdva-30594-magento-patch-multiple-address-checkout-errors.md)
      ...
      * v1.0.9 {#v1-0-9}
         ...
         * [MDVA-31791-korrigering: Förbättring av produktsidan med relaterade produkter och målregler](/help/support-tools/patches-available-in-qpt-tool/v1-0-9/mdva-31791-magento-patch-improvement-for-product-page-with-related-products-and-target-rules.md)
      ...
      * v1.0.14 {#v1-0-14}
         ...
         * [MDVA-28511: Bokförda brev med hängda betalningar](/help/support-tools/patches-available-in-qpt-tool/v1-0-14/mdva-28511-magento-patch-accented-letters-hang-payflow-payments.md)
      ...
      * v1.0.19 {#v1-0-19}
         ...
         * [MDVA-35569: FPT visas inte i GraphQL](/help/support-tools/patches-available-in-qpt-tool/v1-0-19/mdva-35569-magento-patch-fpt-won-t-show-in-graphql.md)
      ...
      * v1.0.22 {#v1-0-22}
         ...
         * [MDVA-36718: Anpassade alternativ behålls efter API-ändring](/help/support-tools/patches-available-in-qpt-tool/v1-0-22/mdva-36718-custom-options-remain-after-api-change.md)
      ...
      * v1.0.26 {#v1-0-26}
         * [Översikt: QPT (Quality Patches Tool) v1.0.26](/help/support-tools/patches-available-in-qpt-tool/v1-0-26/overview.md)
      ...
      * v1.1.22 {#v1-1-22}
         ...
         * [ACSD-4744: [!UICONTROL Trying to access array offset on value of type bool] fel vid åtkomst till vissa kategorisökvägar som inte finns för kända produkter i PHP 7.4](/help/support-tools/patches-available-in-qpt-tool/v1-1-22/acsd-47444-trying-access-array-offset-value-type-bool-error.md)
      ...
      * v1.1.23 {#v1-1-23}
         ...
         * [ACSD-46519: product_count i [!UICONTROL categoryList] [!DNL GraphQL] fråga returnerar 0 för ankarkategorier](/help/support-tools/patches-available-in-qpt-tool/v1-1-23/acsd-46519-product-count-categorylist-graphql-query-returns-zero-anchor-categories.md)
      ...
      * v1.1.24 {#v1-1-24}
         ...
         * [ACSD-46770: E-postmeddelande med orderbekräftelse skickas även när [!UICONTROL Email order confirmation] är avmarkerad](/help/support-tools/patches-available-in-qpt-tool/v1-1-24/acsd-46770-an-order-confirmation-email-is-sent-even-when-the-email-order-confirmation-is-unchecked.md)
         * [ACSD-47336 [!UICONTROL Something went wrong] felmeddelanden har stängts av Adobe Commerce Admin](/help/support-tools/patches-available-in-qpt-tool/v1-1-24/acsd-47336-something-went-wrong-error-when-dismissing-notifications-adobe-commerce-admin.md)
      ...
      * v1.1.25 {#v1-1-25}
         ...
         * [ACSD-48234: Katalogsökresultatet visar felaktigt antal kategoriobjekt när [!UICONTROL Display Out of Stock Products] aktiverad](/help/support-tools/patches-available-in-qpt-tool/v1-1-25/acsd-48234-catalog-search-result-shows-incorrect-category-item-count-when-show-out-of-stock-option-enabled.md)
         ...
         * [ACSD-48313: [!UICONTROL configurable_variations] kolumnen har inte tolkats om attributvärdet innehåller komma](/help/support-tools/patches-available-in-qpt-tool/v1-1-25/acsd-48313-configurable-variations-column-not-parsed-attribute-value-contains-comma.md)
      ...
      * V1.1.27 {#v1-1-27}
         ...
         * [ACSD-48634: [!DNL JS] fel när [!DNL Google Analytics Content Experiments] aktiverad](/help/support-tools/patches-available-in-qpt-tool/v1-1-27/acsd-48634-js-errors-when-google-analytics-content-experiments-enabled.md)
      ...
      * v1.1.29 {#v1-1-29}
         ...
         * [ACSD-49835: [!UICONTROL Use Default Value] kryssrutan har inte sparats](/help/support-tools/patches-available-in-qpt-tool/v1-1-29/acsd-49835-use-default-value-chekbox-not-saved.md)
         ...
         * [ACSD-49502: Hämtningsbar länk har inte uppdaterats korrekt efter [!DNL staging] uppdatera](/help/support-tools/patches-available-in-qpt-tool/v1-1-29/acsd-49502-downloadable-link-not-updated-correctly.md)
         ...
         * [ACSD-50234: Felaktigt kundnamn i bekräftelsemeddelande för beställningar som gjorts med [!DNL PayPal]](/help/support-tools/patches-available-in-qpt-tool/v1-1-29/acsd-50234-incorrect-customer-name-in-confirmation-email-for-orders-placed-with-paypal.md)
      ...
      * v1.1.30 {#v1-1-30}
         ...
         * [ACSD-49973: Förbättrad prestandahämtning för paketerade produkter via [!DNL GraphQL]](/help/support-tools/patches-available-in-qpt-tool/v1-1-30/acsd-49973-improved-performance-fetching-bundled-products-via-graphql.md)
      ...
      * v1.1.32 {#v1-1-32}
         ...
         * [ACSD-51379: Ändringar av sidans textinnehåll via [!DNL Page Builder] har inte sparats](/help/support-tools/patches-available-in-qpt-tool/v1-1-32/acsd-51379-changes-made-to-page-text-content-via-page-builder-are-not-saved.md)
      ...
      * v1.1.35{#v1-1-35}
         ...
         * [ACSD-52786: Katalogregel [!UICONTROL SKU is] gäller för alla produkter som börjar med SKU](/help/support-tools/patches-available-in-qpt-tool/v1-1-35/acsd-52786-catalog-rule-sku-is-applies-to-all-products-starting-with-it.md)
         ...
         * [ACSD-52831: Det går inte att placera överlåtbara offertorder när [!DNL Google reCAPTCHA v3 Invisible] aktiverad](/help/support-tools/patches-available-in-qpt-tool/v1-1-35/acsd-52831-cannot-place-negotiable-quote-orders.md)
      ...
      * v1.1.36{#v1-1-36}
         ...
         * [ACSD-53239: Lagerindexeraren rensar alla cacheminnen i [!UICONTROL Update on Schedule] läge](/help/support-tools/patches-available-in-qpt-tool/v1-1-36/acsd-53239-inventory-indexer-cleans-all-caches.md)
         * [ACSD-5087: [!UICONTROL Use in Search Results Layered Navigation] anges till Ja utan [!UICONTROL Use in Search] option](/help/support-tools/patches-available-in-qpt-tool/v1-1-36/acsd-50887-product-attribute-use-in-search-results-layered-navigation-set-to-yes-without-use-in-search-option.md)
         * [ACSD-51846: Internt fel som [!DNL REST API] nyttolastnivåerna är inte validerade](/help/support-tools/patches-available-in-qpt-tool/v1-1-36/acsd-51846-internal-error-as-levels-of-rest-api-payload-are-not-validated.md)
      ...
      * v1.1.37 {#v1-1-37}
         ...
         * [ACSD 49843: Länken för produktnedladdning är inte tillgänglig efter automatisk fakturering med [!UICONTROL Payment Action] = Försäljning](/help/support-tools/patches-available-in-qpt-tool/v1-1-37/acsd-49843-link-to-product-download-unavailable-after-being-autoinvoiced-with-payment-action-sale.md)
      * v1.1.38 {#v1-1-38}
      ...
      * v1.1.40 {#v1-1-40}
         ...
         * [ASCD-54040: [!UICONTROL Created] fältet är tomt i ordningsinformationen när B2B-moduler är aktiverade](/help/support-tools/patches-available-in-qpt-tool/v1-1-40/acsd-54040-created-field-is-blank-in-order-details-page.md)
         ...
         * [ACSD-55031: Felet &quot;mixad&quot; kan inte vara nullbart under kompilering](/help/support-tools/patches-available-in-qpt-tool/v1-1-40/acsd-55031-type-mixed-cannot-be-nullable-error-during-compilation.md)
         * [ACSD-54319: Produktpriset är noll på [!UICONTROL Products in Carts] rapport](/help/support-tools/patches-available-in-qpt-tool/v1-1-40/acsd-54319-product-price-shows-zero-in-product-in-cart-report.md)
         * [ACSD-54989: Företagsadministratören kan inte beställa när [!UICONTROL Enable Purchase Orders] inställd på Ja och [!UICONTROL Purchase Order] inställd på Nej](/help/support-tools/patches-available-in-qpt-tool/v1-1-40/acsd-54989-order-placement-restrictions-in-company-admin-settings.md)
      ...
      * v1.1.42 {#v1-1-42}
         ...
         * [ACSD-5512: [!UICONTROL Submit Review] knappen kan klickas flera gånger](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-55112-submit-review-button-can-be-clicked-multiple-times.md)
      ...
      * v1.1.43 {#v1-1-43}
         ...
         * [ACSD-55305: Popup fryser under redigering av företagsanvändare i [!UICONTROL My Account]](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-55305-freeze-issue-in-company-user-edit-popup.md)
         ...
         * [ACSD-53636: Normalpris visas inte på [!UICONTROL Product Listing] page](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-53636-regular-price-is-not-displayed-on-product-listing-page.md)
         ...
         * [ACSD-53309: Ofullständig skatteansökan för anpassningsbara alternativ och &#39;[!UICONTROL Regular Price]etikett](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-53309-incomplete-tax-application-for-customizable-options.md)
         ...
         * [ACSD-54739: [!UICONTROL Product Stock] status inte begärd för [!UICONTROL Related Product Rules]](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-54739-product-stock-status-not-applied-for-related-product-rules.md)
      ...
      * v1.1.44 {#v1-1-44}
         ...
         * [ACSD-56193: [!DNL Fastly/Varnish] cache ej rensad för uppdatering av innehållstaggar](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-56193-fastly-cache-not-cleared-for-content-staging-update.md)
      ...
      * v1.1.45 {#v1-1-45}
         ...
         * [ACSD-54965: [!UICONTROL Visual Merchandising] rutnätet visar inte rätt resurs](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/acsd-54965-visual-merchandising-grid-not-display-correct-stock.md)
         ...
         * [ASCD-56415: Prestanda för [!UICONTROL Partial Price Indexing] är långsam på grund av DELETE-fråga](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/acsd-56415-performance-of-partial-price-indexing-is-slowed-down-due-to-a-delete-query.md)
      * v1.1.46 {#v1-1-46}
         * [Översikt [!DNL Quality Patches Tool] (QPT) v1.1.46](/help/support-tools/patches-available-in-qpt-tool/v1-1-46/overview.md)
         * [ACSD-46767: [!UICONTROL Category] sidan caches invalidisate when the stock quantity changes](/help/support-tools/patches-available-in-qpt-tool/v1-1-46/acsd-46767-category-page-caches-invalidate-when-the-stock-quantity-changes.md)
         * [ACSD-54656: Osynlig [!DNL reCAPTCHA] misslyckas vid utcheckning, vilket förhindrar att ordern läggs](/help/support-tools/patches-available-in-qpt-tool/v1-1-46/acsd-54656-invisible-recaptcha-fails-during-checkout-preventing-order-placement.md)
         ...
         * [ACSD-5100: [!DNL GraphQL] returnerar inte produkter som överstiger 10 kB i sökresultaten](/help/support-tools/patches-available-in-qpt-tool/v1-1-46/acsd-55100-graphql-does-not-return-products-beyond-10k-in-the-search-results.md)
...
* Felsökning {#troubleshooting}
   ...
   * Betalningar {#payments}
      * [Felsök hur du skapar en beställningssida i [!UICONTROL CSP] begränsat läge](/help/troubleshooting/payments/admin-create-order-page-in-csp-restricted-mode.md)
      * [Felsöka utcheckningssidan för storefont på [!UICONTROL CSP] begränsat läge](/help/troubleshooting/payments/storefront-checkout-page-in-csp-restricted-mode.md)
   ...
   * Installation och uppgradering {#installation-and-upgrade}
      ...
      * [[!DNL B2B] 1.4.0-installationen misslyckas på Adobe Commerce 2.4.6-p1 lokalt](/help/troubleshooting/installation-and-upgrade/b2b-1-4-0-installation-fails-on-adobe-commerce-2-4-6-p1-on-premises.md)
   ...
   * Diverse {#miscellaneous}
      ...
      * [Avserialisera felinställningar igen:static-content:driftsätta](/help/troubleshooting/miscellaneous/redis-unserialize-error-setup-static-content-deploy.md)
      ...
      * [körningskonfiguration:static-content:distribuerat_version.txt-problem](/help/troubleshooting/miscellaneous/run-setup-static-content-deploy-deployed-version-txt-issue.md)
      ...
      * [Kronstopp på grund av felkonfigurerad eller saknad [!DNL OpCache settings]](/help/troubleshooting/miscellaneous/crons-blocked-running-missing-opache-settings.md)
      * [Det går inte att ta bort filen. Varning! Bryt länk: Inga sådana fil- eller katalogfel* från [!DNL Admin]](/help/troubleshooting/miscellaneous/file-cannot-be-deleated-no-file-or-directory.md)
      ...
      * [[!DNL Google Tag Manager] bryts av widgeten för Live-sökning](/help/troubleshooting/miscellaneous/google-tag-manager-broken-by-live-search-widget.md)
      * [Säkerhetsluckor som tredjepartssäkerhetsinskannade personer kan råka ut för [!DNL HackerOne]](/help/troubleshooting/miscellaneous/third-party-test-reports-are-handled-by-hackerone.md)
      ...
      * [[!DNL SendGrid] filbegränsning för Adobe Commerce Cloud](/help/troubleshooting/miscellaneous/sendgrid-file-limitation.md)
   ...
   * Kända fel {#known-issues-patches-attached}
      ...
      * [[!DNL JQuery UI] säkerhetsrisk [!DNL CVE-2022-31160] korrigering för version 2.4.4, 2.4.5 och 2.4.6](/help/troubleshooting/known-issues-patches-attached/jquery-cve-2022-31160-fix-2-4-4-2-4-5-2-4-6.md)
      * [[!DNL FedEx] migrering av leveransmetodintegration från SOAP till RESTful API](/help/troubleshooting/known-issues-patches-attached/fedex-shipping-method-integration-migration-soap-restful-api.md)
   * Elasticsearch {#elasticsearch}
      * [Fallar tillbaka till [!DNL Elasticsearch7] när sökmotorn är inställd på [!DNL Opensearch]](/help/troubleshooting/elasticsearch/falling-back-to-elasticsearch7-when-search-engine-set-to-opensearch.md)
