...
En lista över beräknade kolumner som du kan skapa i Data Warehouse Manager samt riktlinjer för att se till att de är korrekt konfigurerade finns i följande artiklar i vår användarhandbok:
...
Om du behöver hjälp med att skapa en vanlig beräknad kolumn eller vill skapa eller redigera en avancerad beräknad kolumn, [kontakta vårt team](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#submit-ticket) och inkludera följande:
