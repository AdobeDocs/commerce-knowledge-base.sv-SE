...
Korrigeringen ACSD-55004 åtgärdar ett problem där en validerare kraschar när en importfil som är större än det värde som konfigurerats i överförs `php.ini`. Den här korrigeringen är tillgänglig när [!DNL Quality Patches Tool (QPT)] 1.1.40 är installerat. Korrigerings-ID är ACSD-55004. Observera att problemet är planerat att åtgärdas i Adobe Commerce 2.4.7.
...
Valideraren kraschar vid överföring av en importfil som är större än värdet som konfigurerats i `php.ini`.
