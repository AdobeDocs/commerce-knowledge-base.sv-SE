...
Korrigeringen ACSD-46213 åtgärdar ett problem där kategoriträdets begäran är begränsad till 20 kategorier. Den här korrigeringen är tillgänglig när [QPT (Quality Patches Tool)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.19 är installerat. Korrigerings-ID är ACSD-46213.
