...
1. Skapa en ny schemalagd uppdatering för produkten med alla parametrar utan att ändra *Bilder och video* -avsnitt.
1. Klicka på **Visa/redigera** i schemalagda ändringar.
1. Gå till **Bilder och video** och klicka på videon.
