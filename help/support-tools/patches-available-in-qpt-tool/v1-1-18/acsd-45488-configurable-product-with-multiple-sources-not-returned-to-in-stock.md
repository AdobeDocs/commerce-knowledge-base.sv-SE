...
1. Ange att båda de associerade produkterna ska *slut på lager*.
1. Kontrollera `stock_status` från `cataloginventory_stock_status`.
...
Lagerstatusen för den konfigurerbara produkten uppdateras till *i lager* när de tillhörande produkterna är i lager.

<u>Faktiska resultat</u>:

Den konfigurerbara produktens lagerstatus uppdateras inte till *i lager* när de tillhörande produkterna är i lager.
