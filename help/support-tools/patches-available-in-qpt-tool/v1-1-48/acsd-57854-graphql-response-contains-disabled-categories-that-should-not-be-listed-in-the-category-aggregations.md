...
# ACSD-57854: *GraphQL* svaret innehåller inaktiverade kategorier som inte ska listas i kategoriaggregeringar

Korrigeringen ACSD-57854 åtgärdar ett problem där *GraphQL* svaret innehåller inaktiverade kategorier som inte ska listas i kategoriaggregeringarna. Den här korrigeringen är tillgänglig när [!DNL Quality Patches Tool (QPT)] 1.1.48 är installerat. Patch-ID:t är ACSD-57854. Observera att problemet är planerat att åtgärdas i Adobe Commerce 2.5.0.
...
1. Använd produkter *GraphQL* för att söka efter produkten.
1. Kontrollera listan över produktkategorier i *GraphQL* svar.

<u>Förväntade resultat</u>:

De inaktiverade kategorierna visas inte i *GraphQL* svar.

<u>Faktiska resultat</u>:

De inaktiverade kategorierna listas i kategoriaggregeringen *GraphQL* svar.
