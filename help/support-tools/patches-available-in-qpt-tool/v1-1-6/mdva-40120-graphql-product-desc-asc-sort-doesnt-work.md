...
MDVA-40120-korrigeringen löser problemet där GraphQL sortering efter DESC/ASC inte fungerar med produkter som har samma relevans eller pris. Den här korrigeringen är tillgänglig när [QPT (Quality Patches Tool)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.6 är installerat. Korrigerings-ID är MDVA-40120. Observera att problemet är planerat att åtgärdas i Adobe Commerce 2.4.4.
