...
1. Ange **[!UICONTROL Catalog Price Scope]** till **[!UICONTROL Website]**.
...
1. I steg 2: ange anpassade priser och klicka **[!UICONTROL Configure]**.
1. Ange olika nivåpriser för olika webbplatser.
1. Välj **[!UICONTROL Done]** och klicka på **[!UICONTROL Generate Catalog]** och sedan klicka **[!UICONTROL Save]**.
1. Spring cron.
1. Navigera till **[!UICONTROL Set Pricing and Structure]** > **[!UICONTROL Configure]** > **[!UICONTROL Next]** > **[!UICONTROL Configure]** och verifiera skiktpris.
