...
1. Logga in som kund och lägg till en produkt i [rekvisitionslistan](https://experienceleague.adobe.com/sv/docs/commerce-admin/b2b/requisition-lists/requisition-lists).
