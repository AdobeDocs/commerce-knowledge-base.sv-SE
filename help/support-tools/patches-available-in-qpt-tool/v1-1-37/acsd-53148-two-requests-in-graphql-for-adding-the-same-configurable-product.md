...
Korrigeringen ACSD-53148 åtgärdar ett problem där två parallella förfrågningar i GraphQL om att lägga till samma konfigurerbara produkt i varukorgen resulterade i två separata artiklar i varukorgen med samma produkt-SKU. Den här korrigeringen är tillgänglig när [[!DNL Quality Patches Tool (QPT)]](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.37 är installerat. Korrigerings-ID är ACSD-53148. Observera att problemet är planerat att åtgärdas i Adobe Commerce 2.4.7.
...
1. Skapa en konfigurerbar produkt med SKU *Testa* och en enkel produkt med SKU *Test-A*.
1. Skapa en ny tom kundvagn via GraphQL (ändra plats med din egen [!DNL URL]):
...
1. Hämta vagnen för att se artiklarna (ändra *cartId* och plats):
...
Objekt listade en gång med [!UICONTROL qty] = 2.
...
Objekt listade två gånger med [!UICONTROL qty] = 1.
