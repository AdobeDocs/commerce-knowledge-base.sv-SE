...
1. Skapa en testprodukt (Exempel: *weetax*) med attributet *weee\_tax* tillagt.
1. Tilldela FPT till Kalifornien eller till ett annat läge för attributet *weee\_tax*.
1. Skapa en kund i GraphQL.
1. Skapa en kundvagn i GraphQL.
1. Lägg *weetax*-produkten i kundvagnen med GraphQL.
1. Fråga kundvagnen:
