---
title: 'MDVA-36572: Ny lagerreservation skapad efter uppdatering av kreditnota'
description: Korrigeringen MDVA-36572 åtgärdar ett problem där en ny lagerreservation skapas efter att kreditnotan har uppdaterats. Den här korrigeringen är tillgänglig när [QPT-verktyget (Quality Patches Tool)](https://devdocs.magento.com/guides/v2.4/comp-mgr/patching.html#mqp) 1.0.25 är installerat. Patch-ID:t är MDVA-36572. Observera att problemet är planerat att åtgärdas i Adobe Commerce 2.4.4.
...
1. Skapa ny order, faktura och kreditnota för ordern.
1. Skapa ny integrering.
1. Kontrollera lagerbokningstabell:
...
1. Skicka GET-förfrågan till: `../rest/default/V1/creditmemo/3`
1. Kopiera svar (exempel):
...
1. Skicka POST till: `../rest/default/V1/creditmemo`
