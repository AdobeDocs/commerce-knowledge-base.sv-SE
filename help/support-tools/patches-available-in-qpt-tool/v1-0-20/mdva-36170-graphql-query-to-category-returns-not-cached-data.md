...
Korrigeringen MDVA-36170 åtgärdar ett problem där resultatet av GraphQL-frågan inte cachelagras. Den här korrigeringen är tillgänglig när [QPT (Quality Patches Tool)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.0.20 är installerat. Korrigerings-ID är MDVA-36170. Observera att problemet har åtgärdats i Adobe Commerce 2.4.2.
