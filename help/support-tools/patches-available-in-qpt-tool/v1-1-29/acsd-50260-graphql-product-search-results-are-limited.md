...
Korrigeringen ACSD-50260 åtgärdar ett problem där sökresultaten för GraphQL-produkter begränsas till 10 000 resultat. Den här korrigeringen är tillgänglig när [[!DNL Quality Patches Tool (QPT)]](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.29 är installerat. Korrigerings-ID är ACSD-50260. Observera att problemet är planerat att åtgärdas i Adobe Commerce 2.4.6.
