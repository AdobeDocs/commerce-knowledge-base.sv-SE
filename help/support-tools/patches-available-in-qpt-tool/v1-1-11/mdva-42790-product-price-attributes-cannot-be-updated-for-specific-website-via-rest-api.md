...
MDVA-42790-korrigeringen åtgärdar ett problem där användare inte kan uppdatera produktprisattribut för specifika webbplatser via REST API. Den här korrigeringen är tillgänglig när [QPT (Quality Patches Tool)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.11 är installerat. Korrigerings-ID är MDVA-42790. Observera att problemet är planerat att åtgärdas i Adobe Commerce 2.4.5.
...
1. Gå till Admin **Lager** > **Konfiguration** > **Katalog** > **Pris** > och ange **Katalogprisomfång** till webbplats.
1. Uppdatera specialpris för en paketerad produkt med hjälp av REST API, `POST rest/V1/products/`.
...
Specialpriset uppdateras för den paketerade produkten när **Katalogprisomfång** är inställt på Webbplats.

<u>Faktiska resultat</u>:

Specialpriset uppdateras inte för den paketerade produkten när **Katalogprisomfång** är inställt på Webbplats.
