...
description: Adobe Commerce lokalt, Adobe Commerce i molninfrastruktur och Magento Open Source 2.4.0 kommer att släppas under de närmaste månaderna. För Adobe Commerce lokalt och Magento Open Source version 2.4.0 är Elasticsearch 6.x eller 7.x en obligatorisk komponent och MySQL-sökmotorn tas bort. Elasticsearch krävs redan i Adobe Commerce om molninfrastruktur.
...
<td style="width: 478.2px;">Elasticsearch 5 har nått <a href="https://www.elastic.co/support/eol">slutet av livscykeln</a> och har tagits bort i Adobe Commerce 2.4.0. Uppdatera till Elasticsearch 7 (rekommenderas) eller 6.</td>
</tr>
<tr>
...
Under installationen kontrolleras Elasticsearch-anslutningen och installationen misslyckas om Adobe Commerce inte kan ansluta till en Elasticsearch-värd. Om detta inträffar kontrollerar du att Elasticsearch är igång och att du har angett rätt anslutningsparametrar.
