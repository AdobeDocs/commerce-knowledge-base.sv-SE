...
Du kan bekräfta problemet med följande fel i `var/report` katalog:
...
Installera Adobe Commerce med [kommandorad](https://devdocs.magento.com/guides/v2.3/install-gde/install/cli/install-cli.html).
