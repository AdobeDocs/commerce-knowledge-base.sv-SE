...
**Problem**: Jag växlade till [!UICONTROL Shared Access]-kontot, men när jag försöker skicka en biljett på [Experience League](https://experienceleague.adobe.com/home?lang=sv-SE#support) finns ingen organisation tillgänglig eller så visas inte organisationsnamnet i listrutan.
