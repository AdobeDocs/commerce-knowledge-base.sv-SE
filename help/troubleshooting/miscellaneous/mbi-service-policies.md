...
Du kan [skicka en biljett](https://experienceleague.adobe.com/sv/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide) till vårt supportteam genom att klicka på länken **Skicka en biljett** överst på sidan. Vi rekommenderar att du checkar ut [Information i din supportanmälan](https://experienceleague.adobe.com/sv/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide) innan du kontaktar oss för att se till att all nödvändig information finns i din första anmälan.
